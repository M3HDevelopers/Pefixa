...
export const toolRegistry: ToolDefinition[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  t('pdf-to-word','PDF to Word','Convert PDF to DOC/DOCX','convert-from','backend-required','application/vnd.openxmlformats-officedocument.wordprocessingml.document',[{key:'format',label:'Format',type:'select',default:'docx',options:[{value:'docx',label:'DOCX'},{value:'doc',label:'DOC'}]}],{...batch,aliases:['pdf to docx']}),
  t('pdf-to-excel','PDF to Excel','Extract tables to XLSX/CSV','convert-from','backend-required','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',[{key:'format',label:'Format',type:'select',default:'xlsx',options:[{value:'xlsx',label:'XLSX'},{value:'csv',label:'CSV'}]}],{...batch}),
  t('pdf-to-powerpoint','PDF to PowerPoint','Convert pages/content to PPT/PPTX','convert-from','backend-required','application/vnd.openxmlformats-officedocument.presentationml.presentation',[{key:'format',label:'Format',type:'select',default:'pptx',options:[{value:'pptx',label:'PPTX'},{value:'ppt',label:'PPT'}]}],{...batch}),
  ...
  t('doc-to-pdf','DOC/DOCX to PDF','Office document conversion','convert-to','backend-required','application/pdf',[],{acceptedTypes:['application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/msword']}),
  t('xls-to-pdf','XLS/XLSX to PDF','Spreadsheet conversion','convert-to','backend-required','application/pdf',[],{acceptedTypes:['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/vnd.ms-excel']}),
  t('ppt-to-pdf','PPT/PPTX to PDF','Presentation conversion','convert-to','backend-required','application/pdf',[],{acceptedTypes:['application/vnd.openxmlformats-officedocument.presentationml.presentation']}),
