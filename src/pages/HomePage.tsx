            ...
            <div className="grid grid-cols-3 gap-5">
              {[
                ...
                <LiquidCard key={i} className="p-6">
                  <div className="icon-box w-12 h-12 mb-4">
                    <feature.icon size={20} color={getToolColor(feature.title.toLowerCase().replace(/\s+/g, '-'))} />
                  </div>
                ...
                <div key={i} className="relative">
                  <LiquidCard className="p-8 text-center">
                    ...
                    <div className="icon-box w-14 h-14 mx-auto mb-4">
                      <item.icon size={22} color={getToolColor(item.title.toLowerCase().replace(/\s+/g, '-'))} />
                    </div>
                ...
                <LiquidCard key={i} className="p-7">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="icon-box w-12 h-12">
                      <useCase.icon size={18} color={getToolColor(useCase.title.toLowerCase().replace(/\s+/g, '-'))} />
                    </div>
                ...
                {recentTools.map(slug => {
                  ...
                  return (
                    <Link
                      ...
                      data-hover="fill"
                    >
                      <Icon size={12} color={getToolColor(slug)} />
